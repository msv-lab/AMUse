...
from .grammar import souffle_grammar
...
# rules: list of rules
Program = namedtuple(
    "Program", ["declarations", "inputs", "outputs", "include", "rules"]
)
...
def pprint(program):
    def pprint_term(term):
        ...
        if isinstance(term, String):
            # replace quote char with escaped quote char
    ...
    for directive in program.include:
        result += f'#include "{directive}"\n'
